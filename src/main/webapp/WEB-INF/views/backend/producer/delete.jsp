                ...
                <div class="col-lg-12">
                    <div class="card-style mb-30">
                        ...
                        <c:forEach var="producer" items="${producer}">
                            <form method="post" class="row g-3 was-validated d-flex justify-content-center" action="/backend/producer/deleteProducer">
                                <div class="col-sm-12 p-3 ">
                                    ...
                                    <button type="submit" class="mt-3 btn btn-danger">Xóa Nhà Sản Xuất</button>
                                </div>
                            </form>
