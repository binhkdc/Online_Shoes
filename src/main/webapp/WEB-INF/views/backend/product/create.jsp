                        ...
                        <form method="post" class="row g-3 was-validated d-flex justify-content-center" action="save" enctype="multipart/form-data">
                            <div class="col-sm-12 p-3 ">
                                <div class="col-md-12">
                                    ...
                                    <label for="tengiay" class="form-label">Tên nhà sản xuất</label>
                                    <select class="form-select mb-3" aria-label="Default select example" name="mansx" required>
                                ...
                                <select class="form-select mb-3" aria-label="Default select example" name="maloaigiay" required>
